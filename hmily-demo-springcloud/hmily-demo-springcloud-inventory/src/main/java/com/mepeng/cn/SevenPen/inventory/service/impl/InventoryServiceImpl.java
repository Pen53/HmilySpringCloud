...
import com.mepeng.cn.SevenPen.inventory.entity.InventoryDO;
import com.mepeng.cn.SevenPen.inventory.mapper.InventoryMapper;
...
public class InventoryServiceImpl implements InventoryService {
    ...
    public Boolean mockWithTryException(InventoryDTO inventoryDTO) {
        LOGGER.info("==========springcloud调用扣减库存 mockWithTryException 库存扣减异常===========");
        //这里是模拟异常所以就直接抛出异常了
